...
**Worktree port band**:
The shared range **Worktree PORT**s are drawn from, chosen to sit clear of the machine's always-on main-checkout servers. One band across all projects, not per-project.
